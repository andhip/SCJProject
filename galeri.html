      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              <div class="card h-100 card-content border-secondary rounded-0 ">
                <img class="ard-img rounded-0 img-fluid p-2" src="assets/Images/albumss/" alt="Perpustakaan">
                <div class="card-body pb-2">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <div id="carouselExample7" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img class="d-block w-100" src="assets/Images/albums/olahraga1.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="assets/Images/albums/olahraga2.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="assets/Images/albums/olahraga3.jpg" alt="Third slide">
                        </div>
                        <div class="carousel-item">
                          <img class="d-block w-100" src="assets/Images/albums/olahraga4.jpg" alt="Fourth slide">
                        </div>
